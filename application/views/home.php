...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Olá, é que bom que você está aqui!!!</h1>
        <p>Aqui vai a descrição do projeto...</p>
        <p><a class="btn btn-primary btn-lg" href="<?=site_url('Usuario/carregaCadastrarUsuario')?>" role="button">Desejo me cadastrar &raquo;</a></p>
      </div>
    </div>
